<?php 
    ...
    if(isset($_POST['btnDelete'])){
        // verification si saisie de champs
            $stmtUpdate = $bdd->prepare("DELETE FROM articles WHERE reference = :reference");
    ...
    <div id="main_page">
        ...
        <section>
            <div class="container bg-light mb-0 mt-2">
                ...
                <h1>Formulaire de Suppresion d'Article:  <strong class="text-danger"><?php echo $rowGet['reference']; ?></strong></h1>
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <button  type="submit" name="btnDelete" onclick="return confirm('Confirmer la suppression ?')" class="btn btn-primary mb-2">Suppression de  l'article</button>
                    </div>
                </form>
            </div>
        </section>
